...
class MainForm:
    ...
    def getMultilangRegExp(self, txt):
        ret = "(?i)"
        gr = {'w':'wв', 'e':'eеёэ', 'r':'rр', 't':'tт', 'y':'yы', 'u':'uую',
         'i':'iи', 'o':'oо', 'p':'pп', 'a':'aая', 's':'sсшщ', 'd':'dд',
         'f':'fф', 'g':'gгж', 'h':'hх', 'j':'jйж', 'k':'kк', 'l':'lл', 'z':'zз',
         'c':'cцч', 'v':'vв', 'b':'bб', 'n':'nн', 'm':'mм',"'":"'ъь",
         '2':'2абвгabc', '3':'3деёжзdef', '4':'4ийклjhi', '5':'5мнопjkl',
         '6':'6рстуmno', '7':'7фхчцpqrs', '8':'8шщьыtuv', '9':'9ъэюяwxyz',
         '0':'0 '}
        s = txt.lower()
        for ch in s:
            if ch in gr:
