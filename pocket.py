...
class MainForm:
    ...
    def getMultilangRegExp(self, txt):
        ret = "(?i)"
        gr = {'w':'в', 'e':'еёэ', 'r':'р', 't':'т', 'y':'ы', 'u':'ую',
         'i':'и', 'o':'о', 'p':'п', 'a':'ая', 's':'сшщ', 'd':'д',
         'f':'ф', 'g':'гж', 'h':'х', 'j':'йж', 'k':'к', 'l':'л', 'z':'з',
         'c':'цч', 'v':'в', 'b':'б', 'n':'н', 'm':'м',"'":"ъь",
         '2':'абвгabcячц', '3':'деёжзdefэф', '4':'ийклghiгжх',
         '5':'мнопjklйжкл', '6':'рстуmnoмно', '7':'фхчцpqrsпрсшщ',
         '8':'шщьыtuvтуюв', '9':'ъэюяwxyzвыз', '0':' '}
        s = txt.lower()
        for ch in s:
            if ch in gr:
                ret += '['+ch+gr[ch]+']'
